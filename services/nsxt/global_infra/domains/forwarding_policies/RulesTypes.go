...
func rulesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/{domainId}/forwarding-policies/{forwardingPolicyId}/rules/{ruleId}",
		"",
		resultHeaders,
		200,
		"",
...
func rulesListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/{domainId}/forwarding-policies/{forwardingPolicyId}/rules",
		"",
		resultHeaders,
		200,
		"",
