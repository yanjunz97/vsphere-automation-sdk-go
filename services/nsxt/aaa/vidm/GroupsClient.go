...
func NewGroupsClient(connector vapiProtocolClient_.Connector) *groupsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.aaa.vidm.groups")
...
func (gIface *groupsClient) List(searchStringParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.VidmInfoListResult, error) {
	...
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.aaa.vidm.groups", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.VidmInfoListResult
