...
type StatisticsClient interface {
	...
	Get(lbServiceIdParam string, lbPoolIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.AggregateLBPoolStatistics, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.lb_services.lb_pools.statistics")
...
func (sIface *statisticsClient) Get(lbServiceIdParam string, lbPoolIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.AggregateLBPoolStatistics, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.lb_services.lb_pools.statistics", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.AggregateLBPoolStatistics
