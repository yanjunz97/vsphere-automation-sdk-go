...
type DetailedStatusClient interface {
	...
	Get(lbServiceIdParam string, lbPoolIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.AggregateLBPoolStatus, error)
}
...
func NewDetailedStatusClient(connector vapiProtocolClient_.Connector) *detailedStatusClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.lb_services.lb_pools.detailed_status")
...
func (dIface *detailedStatusClient) Get(lbServiceIdParam string, lbPoolIdParam string, enforcementPointPathParam *string, sourceParam *string) (nsx_policyModel.AggregateLBPoolStatus, error) {
