...
func precheckByClustersUpdateInputType() vapiBindings_.StructType {
	fields := make(map[string]vapiBindings_.BindingType)
	fieldNameMap := make(map[string]string)
	fields["precheck_parameters"] = vapiBindings_.NewReferenceType(nsx_policyModel.PrecheckParametersBindingType)
...
func PrecheckByClustersUpdateOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.NvdsUpgradePrecheckIdBindingType)
}

func precheckByClustersUpdateRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	fieldNameMap["precheck_parameters"] = "PrecheckParameters"
	fieldNameMap["tolerate_different_configurations"] = "TolerateDifferentConfigurations"
	paramsTypeMap["precheck_parameters"] = vapiBindings_.NewReferenceType(nsx_policyModel.PrecheckParametersBindingType)
