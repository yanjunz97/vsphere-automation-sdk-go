...
type StatisticsClient interface {
	...
	List(domainIdParam string, bridgeFirewallPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.SecurityPolicyStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.bridge_firewall_policies.statistics")
...
func (sIface *statisticsClient) List(domainIdParam string, bridgeFirewallPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.SecurityPolicyStatisticsListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.bridge_firewall_policies.statistics", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SecurityPolicyStatisticsListResult
