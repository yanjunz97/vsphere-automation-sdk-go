...
func statisticsListInputType() vapiBindings_.StructType {
	...
	fields["forwarding_rule_id"] = vapiBindings_.NewStringType()
...
func StatisticsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.ForwardingRuleStatisticsListResultBindingType)
}
...
func statisticsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["forwarding_rule_id"] = vapiBindings_.NewStringType()
	...
	paramsTypeMap["forwardingRuleId"] = vapiBindings_.NewStringType()
