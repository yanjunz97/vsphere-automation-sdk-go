...
func StatisticsListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.ForwardingPolicyStatisticsListResultBindingType)
}
...
func statisticsListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/domains/{domainId}/forwarding-policies/{forwardingPolicyId}/statistics",
		"",
		resultHeaders,
		200,
		"",
