...
func effectiveSignaturesGetInputType() vapiBindings_.StructType {
...
func EffectiveSignaturesGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.IdsProfileSignaturesBindingType)
}

func effectiveSignaturesGetRestMetadata() vapiProtocol_.OperationRestMetadata {
