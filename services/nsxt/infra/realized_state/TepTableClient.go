...
type TepTableClient interface {
	...
	List(realizedLsIdParam string, cursorParam *string, formatParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (nsx_policyModel.VtepListResult, error)
}
...
func NewTepTableClient(connector vapiProtocolClient_.Connector) *tepTableClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.realized_state.tep_table")
...
func (tIface *tepTableClient) List(realizedLsIdParam string, cursorParam *string, formatParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (nsx_policyModel.VtepListResult, error) {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.realized_state.tep_table", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.VtepListResult
