...
// Possible value for ``format`` of method MacTable#list.
const MacTable_LIST_FORMAT_JSON = "json"

// Possible value for ``format`` of method MacTable#list.
const MacTable_LIST_FORMAT_CSV = "csv"
...
func macTableListInputType() vapiBindings_.StructType {
	...
	fields["realized_ls_id"] = vapiBindings_.NewStringType()
	fields["cursor"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	fields["format"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	...
	fieldNameMap["realized_ls_id"] = "RealizedLsId"
...
func MacTableListOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.MacAddressListResultBindingType)
}
...
func macTableListRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	paramsTypeMap["realized_ls_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["sort_ascending"] = vapiBindings_.NewOptionalType(vapiBindings_.NewBooleanType())
	paramsTypeMap["project_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["included_fields"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	paramsTypeMap["org_id"] = vapiBindings_.NewStringType()
	paramsTypeMap["format"] = vapiBindings_.NewOptionalType(vapiBindings_.NewStringType())
	...
	paramsTypeMap["realizedLsId"] = vapiBindings_.NewStringType()
	pathParams["realized_ls_id"] = "realizedLsId"
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/realized-state/{realizedLsId}/mac-table",
		"",
		resultHeaders,
		200,
		"",
