...
func (cIface *csrsClient) Create(orgIdParam string, projectIdParam string, csrIdParam string, tlsCsrParam nsx_policyModel.TlsCsr) (nsx_policyModel.TlsCsr, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.csrs", "create", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsCsr
...
func (cIface *csrsClient) Delete(orgIdParam string, projectIdParam string, csrIdParam string) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.csrs", "delete", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (cIface *csrsClient) Get(orgIdParam string, projectIdParam string, csrIdParam string) (nsx_policyModel.TlsCsr, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.csrs", "get", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsCsr
	if methodResult.IsSuccess() {
...
func (cIface *csrsClient) Importcsr(orgIdParam string, projectIdParam string, csrIdParam string, tlsTrustDataParam nsx_policyModel.TlsTrustData) (nsx_policyModel.TlsCertificate, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.csrs", "importcsr", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsCertificate
	if methodResult.IsSuccess() {
...
func (cIface *csrsClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.TlsCsrListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.csrs", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsCsrListResult
	if methodResult.IsSuccess() {
...
func (cIface *csrsClient) Selfsign(orgIdParam string, projectIdParam string, csrIdParam string, daysValidParam int64) (nsx_policyModel.TlsCertificate, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.csrs", "selfsign", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsCertificate
	if methodResult.IsSuccess() {
...
func (cIface *csrsClient) Selfsign0(orgIdParam string, projectIdParam string, tlsCsrWithDaysValidParam nsx_policyModel.TlsCsrWithDaysValid) (nsx_policyModel.TlsCertificate, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.csrs", "selfsign_0", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.TlsCertificate
	if methodResult.IsSuccess() {
